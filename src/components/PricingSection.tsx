...
const PricingSection = () => {
  ...
  const plans = [
    {
      name: "Basic",
      originalPrice: "₹999", // Changed
      discountedPrice: "₹399", // Changed
    ...
    {
      name: "Premium",
      originalPrice: "₹1299", // Changed
      discountedPrice: "₹499", // Changed
      description: "Most popular choice",
      features: [
        "Complete App",
        "AI Feature Implementation",
        "Deploy to Internet-Everyone Can See",
        "Amazing PPT",
    ...
    },
    {
      ...
      features: [
        ...
        "Personal Website",
        "Mock VIVA AI-For Practicing",
        "DT Playbook Content for Your Team"
      ]
    }
  ];
