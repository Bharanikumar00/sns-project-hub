...
const PricingSection = () => {
  ...
  const plans = [{
    ...
    features: ["1 Project Domain", "Basic Documentation", "Email Support", "3 Revision Rounds"]
  }, {
    name: "Premium",
    price: "₹24,999",
    description: "Most popular choice",
    features: ["2 Project Domains", "Advanced Documentation", "Priority Email & Chat Support", "Unlimited Revisions", "Research Paper Support"]
  }, {
    name: "Ultimate",
    price: "₹34,999",
    description: "For complex projects",
    features: ["3 Project Domains", "Premium Documentation", "24/7 Priority Support", "Unlimited Revisions", "Research Paper & Publication", "1-on-1 Mentorship"]
  }];
